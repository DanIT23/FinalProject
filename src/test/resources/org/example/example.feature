Feature: An example
  ...
  Scenario: Go to Jane Doe Twitter page
    Given I am on the main page
    When  I click on Instructor
  ...
  Scenario: Negativ Test insert email
    Given I am on the main page
    When  The email value of "testertest.com" is inputted
    And   The submit button is clicked
  ...
  Scenario: Positive - There is no limit character  //bugs//
    Given I am on the main page
  ...
  Scenario: Positive - Read More for Learn Selenium   //bugs//
    Given  I am on the main page
    When   Click button read more for learn selenium
    Then   "Learn Selenium" does is not open
